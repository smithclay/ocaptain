...
> Manage and coordinate a fleet of Claude Code-enabled VMs using a small-ish shell script.

Lightweight multi-coding agent control plane built on top of [exe.dev](https://exe.dev) VMs. Just under 1,400 lines of code.
